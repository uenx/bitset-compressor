//Source https://gist.github.com/1995eaton/86f10f4d0247b4e4e65e
...
module.exports = {
        encode: function (data, aProb) {
            ...
            var header = Object.keys(dict).map(function (e) {
                //return e + '|' + dict[e];
                encodedSize += prob[e] * dict[e].length
                return null
            })
            header = ""
  ...
  /*
  var enc = encode('TESTTESTTESTTESTTESTTESTTESTTEST123abc');
  log(enc);
  */
